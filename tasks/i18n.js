...
module.exports = function(grunt) {
  var generateOutputPath, handleError, translateTemplate;
  grunt.registerMultiTask('i18n', 'Localize Grunty templates', function() {
  ...
  translateTemplate = function(templatePath, localePath, options) {
    var e, locale, localeFileContent, template, templateOptions;
